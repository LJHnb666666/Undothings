...
public final class MyUndoListBean {
    @ColumnInfo(name = "my_undo_id") private final int undoId;
    ...
    public MyUndoListBean(int undoId, Calendar undoDate, Calendar lastDoDate) {
        this.undoId = undoId;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.undoId == target.undoId
